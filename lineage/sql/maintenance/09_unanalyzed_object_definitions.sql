...
BEGIN
  ...
  -- repository share one project; set it once. Their *_project_id variables live
  -- in [C] and default to this.
  ...
  -- line only if that role's objects live in a separate project.
